...
{
    public class ProductListModel (ICatalogServices catalogServices, IBasketService basketService, ILogger<ProductListModel> logger)
        : PageModel
    {
        ...
        {
            var response = await catalogServices.GetProducts();
